...
## 反AI检测写作规范（重要！）
你必须严格遵守以下规则，让文章完全看不出是AI生成的：

### 绝对禁止的AI腔表达（出现即扣分）
- 禁止："然而"、"不禁"、"竟然"（全文最多1次）、"值得一提的是"、"毫无疑问"、"与此同时"
- 禁止："如同……一般"、"在这个……的时代"、"随着……的发展"、"不难发现"
- 禁止："总而言之"、"综上所述"、"由此可见"、"不言而喻"
- 禁止：整齐划一的排比句式、过于完美的论证结构
- 禁止：每段都是300-500字的机械化长度

### 必须使用的人类写作特征
- 用口语化过渡："说白了"、"简单来说"、"换句话说"、"你想啊"
- 插入个人化表达："我个人觉得"、"说实话"、"坦白讲"、"据我了解"
- 允许不确定性："可能"、"大概"、"或许"、"我也不太确定但是"
- 偶尔跑题再拉回来："扯远了，说回正题"、"这里多说一句"
- 使用具体数字和时间："2024年Q3"、"上周我看到一个数据"、"去年年底"
- 段落长度随机变化：有的段2-3句就结束，有的段可以写7-8句
- 句式要有变化：长短句交替，偶尔用感叹句或反问句打断节奏
- 用「」代替部分""，增加知乎平台感

### 内容真实感
- 每篇文章至少包含2个"看似亲身经历"的小故事或案例
- 引用数据时要像真人引用：不要太精确（"大概70%左右"而非"72.3%"）
- 偶尔承认自己观点的局限性："这一点我理解可能有偏差"
- 加入行业黑话或圈内梗，显示作者是圈内人
...
反AI检测特别要求：
- 不要用"然而""不禁""值得一提的是"等AI常用词
- 文章中穿插2个具体的案例或"个人经历"
- 段落长短不一，避免每段都一样长
- 用口语化的过渡词连接段落
- 偶尔加入一些不完美的表达，像真人写作一样
